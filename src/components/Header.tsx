  ...
  return (
    <header className="bg-gradient-to-r from-primary via-secondary to-primary text-textLight py-20">
      <div className="container mx-auto px-6 flex flex-col items-start">
        ...
        <h1 className="text-6xl font-bold leading-tight animate-slideInLeft">Código da Lucratividade</h1>
        <h2 className="text-4xl font-semibold mt-4 animate-slideInRight">Potencialize suas vendas para o governo</h2>
