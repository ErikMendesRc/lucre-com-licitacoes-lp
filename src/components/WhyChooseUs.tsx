  ...
  return (
    <section className="bg-secondary text-textLight py-8 md:py-12">
      <div className="container mx-auto text-center px-4 md:px-6">
        <h2 className="text-3xl md:text-4xl font-bold mb-8 md:mb-12">Por que escolher a Lucre com Licitações?</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          <div className="flex flex-col items-center p-4 md:p-6 bg-primary rounded-lg shadow-lg">
